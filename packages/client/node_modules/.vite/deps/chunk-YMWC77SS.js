...
var o = { registerFunctionSelector: true, openAccess: true, accessList: [] };
...
var r2 = v;
var a2 = v;
var i2 = z.array(r2.or(P)).default(o.accessList);
var d3 = z.intersection(z.object({ name: G.optional(), registerFunctionSelectors: z.boolean().default(o.registerFunctionSelector) }), z.discriminatedUnion("openAccess", [z.object({ openAccess: z.literal(true).default(o.openAccess) }), z.object({ openAccess: z.literal(false), accessList: i2 })]));
var u = z.object({ value: z.union([z.string(), z.number(), z.instanceof(Uint8Array)]), type: z.string() });
var m = z.object({ type: z.nativeEnum(N), input: z.string() });
var p2 = z.object({ name: a2, root: z.boolean().default(false), args: z.array(z.union([u, m])).default([]) });
var y2 = z.object({ worldContractName: z.string().optional(), worldInterfaceName: z.string().default(t2.worldInterfaceName), systems: z.record(r2, d3).default(t2.systems), excludeSystems: z.array(r2).default(t2.excludeSystems), postDeployScript: z.string().default(t2.postDeployScript), deploysDirectory: z.string().default(t2.deploysDirectory), worldsFile: z.string().default(t2.worldsFile), worldgenDirectory: z.string().default(t2.worldgenDirectory), worldImportPath: z.string().default(t2.worldImportPath), modules: z.array(p2).default(t2.modules) });
var w2 = y2.catchall(z.any());
...
var p3 = { namespace: "", enums: {}, userTypes: {} };
...
var h2 = z.record(_2, u3).refine((e2) => Object.keys(e2).length > 0, "Table schema may not be empty");
var M2 = u3.transform((e2) => h2.parse({ value: e2 }));
var w3 = h2.or(M2);
var x3 = z.object({ directory: z.string().default(c3.directory), name: G.optional(), tableIdArgument: z.boolean().default(c3.tableIdArgument), storeArgument: z.boolean().default(c3.storeArgument), dataStruct: z.boolean().optional(), keySchema: B2, valueSchema: w3, offchainOnly: z.boolean().default(c3.offchainOnly) }).transform((e2) => (Object.keys(e2.valueSchema).length === 1 ? e2.dataStruct ?? (e2.dataStruct = false) : e2.dataStruct ?? (e2.dataStruct = true), e2));
var H2 = u3.transform((e2) => x3.parse({ valueSchema: { value: e2 } }));
var G2 = x3.or(H2);
...
var Z2 = z.object({ enums: z.record(P4, V).default(p3.enums) });
var J = z.object({ filePath: z.string(), internalType: z.enum(i3) });
var Q = z.object({ userTypes: z.record($, J).default(p3.userTypes) });
var C2 = z.object({ namespace: O2.default(p3.namespace), storeImportPath: z.string().default(l2.storeImportPath), tables: X, userTypesFilename: z.string().default(l2.userTypesFilename), codegenDirectory: z.string().default(l2.codegenDirectory), codegenIndexFilename: z.string().default(l2.codegenIndexFilename) }).merge(Z2).merge(Q);
...
//# sourceMappingURL=chunk-YMWC77SS.js.map
