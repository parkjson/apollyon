...
function D(c3, i2) {
  ...
  }).filter(P), e2 = l5.length > 0 ? l5[l5.length - 1] : null;
...
var A = class extends r {
  constructor(t2, c3) {
    super(`Hex value "${c3}" has length of ${c3.length - 2}, but expected length of ${g[t2] * 2} for ${t2} type.`);
    __publicField(this, "name", "InvalidHexLengthForStaticFieldError");
  }
};
var v = class extends r {
  constructor(t2, c3) {
    super(`Hex value "${c3}" has length of ${c3.length - 2}, but expected a multiple of ${g[t2] * 2} for ${t2}[] type.`);
...
function T2(e2) {
  return e2.reduce((t2, c3) => t2 + g[c3], 0);
}
function j(e2, t2) {
  let c3 = [], i2 = 0;
  e2.staticFields.forEach((r4) => {
    let s5 = g[r4], o3 = y(r4, N(t2, i2, i2 + s5));
    i2 += s5, c3.push(o3);
  });
...
function L(e2) {
  ...
  let r4 = a3.reduce((s5, o3) => s5 + g[o3], 0);
  if (r4 !== t2)
...
async function Xe({ storageAdapter: a3, onProgress: n, publicClient: m4, address: v2, filters: i2 = [], tableIds: C = [], startBlock: L2 = 0n, maxBlockRange: D2, initialState: I3, indexerUrl: y2 }) {
  ...
  async function Z2(e2) {
    ...
    let t2 = U.pipe(concatMap(async (r4) => {
      if (r4.flatMap((o3) => o3.logs.map((s5) => s5.transactionHash).filter(P)).includes(e2))
        return true;
      try {
        let o3 = r4[0];
...
function j2(e2) {
  return { RegisteredTables: ie(e2, { table: P2.T }, { metadata: { componentName: "RegisteredTables" } }), SyncProgress: ie(e2, { step: P2.String, message: P2.String, percentage: P2.Number, latestBlockNumber: P2.BigInt, lastBlockNumberProcessed: P2.BigInt }, { metadata: { componentName: "SyncProgress" } }) };
}
function R2(e2) {
...
var f3 = u2([]);
var W2 = { uint8: P2.Number, uint16: P2.Number, uint24: P2.Number, uint32: P2.Number, uint40: P2.Number, uint48: P2.Number, uint56: P2.BigInt, uint64: P2.BigInt, uint72: P2.BigInt, uint80: P2.BigInt, uint88: P2.BigInt, uint96: P2.BigInt, uint104: P2.BigInt, uint112: P2.BigInt, uint120: P2.BigInt, uint128: P2.BigInt, uint136: P2.BigInt, uint144: P2.BigInt, uint152: P2.BigInt, uint160: P2.BigInt, uint168: P2.BigInt, uint176: P2.BigInt, uint184: P2.BigInt, uint192: P2.BigInt, uint200: P2.BigInt, uint208: P2.BigInt, uint216: P2.BigInt, uint224: P2.BigInt, uint232: P2.BigInt, uint240: P2.BigInt, uint248: P2.BigInt, uint256: P2.BigInt, int8: P2.Number, int16: P2.Number, int24: P2.Number, int32: P2.Number, int40: P2.Number, int48: P2.Number, int56: P2.BigInt, int64: P2.BigInt, int72: P2.BigInt, int80: P2.BigInt, int88: P2.BigInt, int96: P2.BigInt, int104: P2.BigInt, int112: P2.BigInt, int120: P2.BigInt, int128: P2.BigInt, int136: P2.BigInt, int144: P2.BigInt, int152: P2.BigInt, int160: P2.BigInt, int168: P2.BigInt, int176: P2.BigInt, int184: P2.BigInt, int192: P2.BigInt, int200: P2.BigInt, int208: P2.BigInt, int216: P2.BigInt, int224: P2.BigInt, int232: P2.BigInt, int240: P2.BigInt, int248: P2.BigInt, int256: P2.BigInt, bytes1: P2.String, bytes2: P2.String, bytes3: P2.String, bytes4: P2.String, bytes5: P2.String, bytes6: P2.String, bytes7: P2.String, bytes8: P2.String, bytes9: P2.String, bytes10: P2.String, bytes11: P2.String, bytes12: P2.String, bytes13: P2.String, bytes14: P2.String, bytes15: P2.String, bytes16: P2.String, bytes17: P2.String, bytes18: P2.String, bytes19: P2.String, bytes20: P2.String, bytes21: P2.String, bytes22: P2.String, bytes23: P2.String, bytes24: P2.String, bytes25: P2.String, bytes26: P2.String, bytes27: P2.String, bytes28: P2.String, bytes29: P2.String, bytes30: P2.String, bytes31: P2.String, bytes32: P2.String, bool: P2.Boolean, address: P2.String, "uint8[]": P2.NumberArray, "uint16[]": P2.NumberArray, "uint24[]": P2.NumberArray, "uint32[]": P2.NumberArray, "uint40[]": P2.NumberArray, "uint48[]": P2.NumberArray, "uint56[]": P2.BigIntArray, "uint64[]": P2.BigIntArray, "uint72[]": P2.BigIntArray, "uint80[]": P2.BigIntArray, "uint88[]": P2.BigIntArray, "uint96[]": P2.BigIntArray, "uint104[]": P2.BigIntArray, "uint112[]": P2.BigIntArray, "uint120[]": P2.BigIntArray, "uint128[]": P2.BigIntArray, "uint136[]": P2.BigIntArray, "uint144[]": P2.BigIntArray, "uint152[]": P2.BigIntArray, "uint160[]": P2.BigIntArray, "uint168[]": P2.BigIntArray, "uint176[]": P2.BigIntArray, "uint184[]": P2.BigIntArray, "uint192[]": P2.BigIntArray, "uint200[]": P2.BigIntArray, "uint208[]": P2.BigIntArray, "uint216[]": P2.BigIntArray, "uint224[]": P2.BigIntArray, "uint232[]": P2.BigIntArray, "uint240[]": P2.BigIntArray, "uint248[]": P2.BigIntArray, "uint256[]": P2.BigIntArray, "int8[]": P2.NumberArray, "int16[]": P2.NumberArray, "int24[]": P2.NumberArray, "int32[]": P2.NumberArray, "int40[]": P2.NumberArray, "int48[]": P2.NumberArray, "int56[]": P2.BigIntArray, "int64[]": P2.BigIntArray, "int72[]": P2.BigIntArray, "int80[]": P2.BigIntArray, "int88[]": P2.BigIntArray, "int96[]": P2.BigIntArray, "int104[]": P2.BigIntArray, "int112[]": P2.BigIntArray, "int120[]": P2.BigIntArray, "int128[]": P2.BigIntArray, "int136[]": P2.BigIntArray, "int144[]": P2.BigIntArray, "int152[]": P2.BigIntArray, "int160[]": P2.BigIntArray, "int168[]": P2.BigIntArray, "int176[]": P2.BigIntArray, "int184[]": P2.BigIntArray, "int192[]": P2.BigIntArray, "int200[]": P2.BigIntArray, "int208[]": P2.BigIntArray, "int216[]": P2.BigIntArray, "int224[]": P2.BigIntArray, "int232[]": P2.BigIntArray, "int240[]": P2.BigIntArray, "int248[]": P2.BigIntArray, "int256[]": P2.BigIntArray, "bytes1[]": P2.StringArray, "bytes2[]": P2.StringArray, "bytes3[]": P2.StringArray, "bytes4[]": P2.StringArray, "bytes5[]": P2.StringArray, "bytes6[]": P2.StringArray, "bytes7[]": P2.StringArray, "bytes8[]": P2.StringArray, "bytes9[]": P2.StringArray, "bytes10[]": P2.StringArray, "bytes11[]": P2.StringArray, "bytes12[]": P2.StringArray, "bytes13[]": P2.StringArray, "bytes14[]": P2.StringArray, "bytes15[]": P2.StringArray, "bytes16[]": P2.StringArray, "bytes17[]": P2.StringArray, "bytes18[]": P2.StringArray, "bytes19[]": P2.StringArray, "bytes20[]": P2.StringArray, "bytes21[]": P2.StringArray, "bytes22[]": P2.StringArray, "bytes23[]": P2.StringArray, "bytes24[]": P2.StringArray, "bytes25[]": P2.StringArray, "bytes26[]": P2.StringArray, "bytes27[]": P2.StringArray, "bytes28[]": P2.StringArray, "bytes29[]": P2.StringArray, "bytes30[]": P2.StringArray, "bytes31[]": P2.StringArray, "bytes32[]": P2.StringArray, "bool[]": P2.T, "address[]": P2.StringArray, bytes: P2.String, string: P2.String };
function M2(e2, r4) {
  return ie(e2, { ...Object.fromEntries(Object.entries(r4.valueSchema).map(([i2, { type: o3 }]) => [i2, W2[o3]])), __staticData: P2.OptionalString, __encodedLengths: P2.OptionalString, __dynamicData: P2.OptionalString }, { id: r4.tableId, metadata: { componentName: r4.name, tableName: `${r4.namespace}:${r4.name}`, keySchema: S(r4.keySchema, ({ type: i2 }) => i2), valueSchema: S(r4.valueSchema, ({ type: i2 }) => i2) } });
}
function B(e2, r4) {
...
function q({ world: e2, tables: r4, shouldSkipUpdateStream: i2 }) {
  ...
  async function T4({ logs: S3 }) {
    ...
    for (let n of C) {
      let y2 = R2(n);
      le(o3.RegisteredTables, y2) ? console.warn("table already registered, ignoring", { newTable: n, existingTable: (_a2 = g2(o3.RegisteredTables, y2)) == null ? void 0 : _a2.table }) : E(o3.RegisteredTables, y2, { table: n }, { skipUpdateStream: i2 == null ? void 0 : i2() });
    }
    for (let n of S3) {
      let { namespace: y2, name: A2 } = I(n.args.tableId), a3 = (_b2 = g2(o3.RegisteredTables, R2({ address: n.address, namespace: y2, name: A2 }))) == null ? void 0 : _b2.table;
      if (!a3) {
      ...
      if (n.eventName === "Store_SetRecord") {
        ...
        let s5 = g2(g4, m4), p3 = (s5 == null ? void 0 : s5.__staticData) ?? "0x", c3 = Pt(p3, n.args.start, size(n.args.data), n.args.data), b3 = zt(a3.valueSchema, { staticData: c3, encodedLengths: (s5 == null ? void 0 : s5.__encodedLengths) ?? "0x", dynamicData: (s5 == null ? void 0 : s5.__dynamicData) ?? "0x" });
        ...
        let s5 = g2(g4, m4), p3 = (s5 == null ? void 0 : s5.__dynamicData) ?? "0x", c3 = Pt(p3, n.args.start, n.args.deleteCount, n.args.data), b3 = zt(a3.valueSchema, { staticData: (s5 == null ? void 0 : s5.__staticData) ?? "0x", encodedLengths: n.args.encodedLengths, dynamicData: c3 });
...
async function ke({ world: e2, config: r4, tables: i2, startSync: o3 = true, ...T4 }) {
  let S3 = { ...Ce(r4).tables, ...i2 }, { storageAdapter: C, components: n } = q({ world: e2, tables: S3, shouldSkipUpdateStream: () => {
    var _a2;
    return ((_a2 = g2(n.SyncProgress, f3)) == null ? void 0 : _a2.step) !== "live";
    ...
    var _a2;
    if (((_a2 = g2(n.SyncProgress, f3)) == null ? void 0 : _a2.step) !== "live" && (E(n.SyncProgress, f3, { step: g4, percentage: m4, latestBlockNumber: s5, lastBlockNumberProcessed: p3, message: c3 }), g4 === "live"))
...
*/
//# sourceMappingURL=chunk-Z2FTHWFV.js.map
